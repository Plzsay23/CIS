...
class CocoProxyPixelDetector(Node):
    def __init__(self, args):
        super().__init__("coco_proxy_pixel_detector_node")
        ...
        self.get_logger().info(
            "coco_proxy_pixel_detector_node started: "
...
def parse_args():
    ...
    parser.add_argument("--class-id", type=int, default=COCO_PROXY_CLASS_ID)
...
def main():
    ...
    rclpy.init()
    node = CocoProxyPixelDetector(args)
